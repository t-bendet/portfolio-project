...
`hero-and-illustration.md` §1 · `motion-and-texture.md` §1, §3.
...
|---|---|---|---|
| 1 | Global header | eyebrow + primary nav (`navigation-spec.md` §1) | always |
...
- The page does point at the translations — through the nav item, in Hebrew
  ...
  who wants it (`navigation-spec.md` §2.2).
