...
| 5 | Footer | per `navigation-spec.md` §4 — which carries the same three links | always |
...
`navigation-spec.md` N-12: chrome and content must work with JS disabled),
...
to `navigation-spec.md` INV-3 (chrome is content-independent), because
