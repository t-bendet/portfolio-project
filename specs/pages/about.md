...
| Binding obligation | reserves the bio-beside-portrait slot; **no other route carries the portrait** (ADR 0018, `hero-and-motion.md` §3) |
| Chrome | per `navigation.md`; eyebrow `T://bendet · about` |

Basis (law): `sitemap.md` §2 row 8, §4 (`/now`, `/uses`, `/resume` rejected) ·
ADR 0018 · `hero-and-motion.md` §2 · `design-brief-for-m2.md` (the
...
`hero-and-motion.md` §3 obliges M4 to **reserve the bio-beside-portrait
